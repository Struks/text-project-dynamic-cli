<template>
    <div class="margin-bottom">
        ...
        <div class="container">
            <article class="mt-5">
                <img v-if="url !== ''" width="300px" height="220px" :src="url" class="group list-group-image mr-3 float-left">
                <img v-if="url == ''" width="300px" height="220px" :src="noimg" class="group list-group-image mr-3 float-left">
...
export default {
    ...
    beforeCreate() {
        ...
        // this.$store.dispatch('getSinglePost', id)
        // console.log(id)
   },
    created(){
